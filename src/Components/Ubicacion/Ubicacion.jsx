...
const Ubicacion = () => {
  return (
        <section className='w-full relative flex justify-end items-center pt-20'>
            <MapContainer
                center={[-32.9728157, -68.7872775]}
                zoom={18}
                className='h-[24rem] w-full shadow-sombra-imagenes z-10'
            ...
            <div className='absolute bg-white z-10 flex flex-col justify-center items-start gap-5 p-12 right-20'>
                    <h2 className='text-[#0830A6] text-3xl font-bold text-start'>¿Cómo encontrarnos?</h2>
