            ...
            <section className='py-10 lg:flex lg:flex-row flex flex-col justify-center items-center gap-10'>
                <article className='bg-white w-full flex flex-col gap-4 group rounded-tr-[6rem] hover:shadow-xl duration-500'>
                    ...
                    <div className='flex flex-col gap-2 px-5 pb-5'>
                        ...
                        <p className='text-sm opacity-60 font-medium'>Ofrecemos coberturas diseñadas para proteger lo más importante en tu vida: tu hogar, vehículo, seguridad personal y responsabilidad civil. Encuentra tranquilidad con nuestros seguros para automóviles, motos, hogares, accidentes personales, incendios y responsabilidad civil profesional.</p>
                ...
                <article className='bg-white w-full flex flex-col gap-4 group rounded-tr-[6rem] hover:shadow-xl duration-500'>
                    ...
                    <div className='flex flex-col gap-2 px-5 pb-5'>
                        ...
                        <p className='text-sm opacity-60 font-medium'>Descubre nuestra gama completa de seguros empresariales diseñados para proteger tus activos, operaciones y empleados. Desde coberturas generales hasta opciones especializadas, ofrecemos soluciones adaptadas a las necesidades específicas de tu negocio para garantizar una protección integral y tranquilidad financiera.</p>
                ...
                <article className='bg-white w-full flex flex-col gap-4 group rounded-tr-[6rem] hover:shadow-xl duration-500'>
                    ...
                    <div className='flex flex-col gap-2 px-5 pb-5'>
                        ...
                        <p className='text-sm opacity-60 font-medium'>Ofrecemos seguros de retiro diseñados para brindar tranquilidad y estabilidad financiera en tus años dorados. Nuestras opciones flexibles se adaptan a tus necesidades individuales, asegurando un futuro cómodo y sin preocupaciones.</p>
