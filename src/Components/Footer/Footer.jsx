    ...
    return ( 
        <div className='bg-[#0830A6] pt-14 shadow-xl z-20'>
            <div className='flex justify-between items-center px-10'>
                ...
                <section className='lg:flex lg:flex-col flex flex-col justify-center items-center text-white gap-3'>
                    <div className='w-full flex justify-end items-center gap-3'>
                        ...
                        <a href="https://wa.me/+542613674277" target='_blank'><FaWhatsapp className='size-6 cursor-pointer hover:text-[#F29494] duration-300'/></a>
                    </div>
                    <div className='space-x-4 font-medium hidden lg:flex'>
