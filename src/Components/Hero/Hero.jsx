...
const Hero = () => {
    return (
        <div className='h-screen flex flex-col justify-center items-center lg:flex lg:flex-row lg:justify-between lg:gap-10 pt-10 sm:pt-0'>
            <section className='h-full flex flex-col justify-center items-center pt-10 lg:pt-0 lg:items-start gap-5 lg:gap-6 lg:pl-20'>
                <div className='relative'>
                    <h1 className='text-[#0830A6] font-bold text-center lg:text-start text-4xl sm:text-5xl px-5 sm:px-0 lg:text-[4rem] 2xl:text-[5rem] m-0'>Protegiendo lo más <span className='text-[#F29494] animate-pulse'>importante</span></h1>
                </div>
                <p className='text-xs sm:text-sm text-center lg:text-start 2xl:text-lg font-medium text-gray-500 w-[80%] border-l-8 border-r-8 p-2 shadow-md bg-white border-[#F29494] rounded-l-xl rounded-r-xl border-opacity-80'>Somos productores de seguros <span className='text-[#F29494]'>ágiles y flexibles</span> dedicados al asesoramiento integral de seguros y administración de riesgos para <span className='text-[#F29494]'>empresas e individuos</span></p>
