  ...
  return (
    <div className='bg-[#f2f2f2]'>
      <div className='relative h-[30rem]'>
        ...
        <h1 className='absolute bottom-16 left-5 lg:left-10 text-white font-bold text-4xl lg:text-6xl'>Seguros de retiro</h1>
        <p className='absolute bottom-5 left-5 lg:left-10 text-white lg:text-xl'><a href="/" className='text-[#f29494] hover:text-[#0830A6] duration-300'>HOME</a>/RETIRO</p>
      </div>
      <section className='flex flex-col justify-center items-center gap-5 lg:py-20 py-10'>
        <h2 className='text-3xl lg:text-5xl px-5 lg:px-0 text-center font-bold text-[#0830A6]'>Tenés un futuro asegurado</h2>
      ...
      <section className='lg:flex lg:flex-row justify-center items-start gap-10 lg:px-20 px-5 py-10'>
        <article className='lg:w-1/2 flex flex-col gap-10'>
            <h2 className='text-3xl text-center lg:text-start lg:text-4xl font-bold text-[#0830A6]'>¿Por qué hacer un seguro de retiro?</h2>
        ...
        <article  className='w-1/2 relative lg:block hidden'>
            <img src="https://res.cloudinary.com/dfschbyq2/image/upload/v1711604506/abuelos-conviviendo-con-nietos-gettyimages_evijnl_upscayl_2x_realesrgan-x4plus_zjyqpp.jpg" alt="" className='shadow-xl rounded-tl-[6rem] h-full'/>
      ...
      <section className='flex flex-col justify-center items-center gap-10 py-10'>
        <h2 className='text-3xl text-center lg:text-4xl font-bold text-[#0830A6]'>Planes ofrecidos</h2>
        <div className='lg:flex lg:flex-row flex flex-col justify-center items-center gap-10'>
          <article className='flex flex-col justify-start items-center gap-4 p-8 bg-white shadow-xl w-[22rem] sm:w-[40rem] lg:w-[25rem] border-t-8 lg:rounded-tl-[6rem] border-t-green-700 h-[20rem]'>
          ...
          <article className='flex flex-col justify-start items-center gap-4 p-8 bg-white shadow-xl w-[22rem] sm:w-[40rem] lg:w-[25rem] border-t-8 border-t-orange-600 h-[20rem]'>
          ...
          <article className='flex flex-col justify-start items-center gap-4 p-8 bg-white shadow-xl w-[22rem] sm:w-[40rem] lg:w-[25rem] border-t-8 lg:rounded-tr-[6rem] border-t-yellow-600 h-[20rem]'>
