  ...
  return (
    <div className='bg-[#f2f2f2]'>
      <div className='relative h-[30rem] z-20'>
        ...
        <h1 className='absolute bottom-16 left-5 lg:left-10 text-white font-bold text-4xl lg:text-6xl'>Seguros para {personaDetail.title.toLowerCase()}</h1>
        <p className='absolute bottom-5 left-5 lg:left-10 text-white lg:text-xl'><Link to="/" className='text-[#f29494] hover:text-white duration-300'>HOME</Link>/<Link to='/personas' className='text-[#f29494] hover:text-white duration-300'>PERSONAS</Link>/{personaDetail.title.toUpperCase()}</p>
      </div>
      ...
      <section className='flex justify-center text-center py-10 w-full '>
        <p className='w-[90%] md:w-[80%] leading-relaxed opacity-80 text-lg'>{personaDetail.text}</p>
      </section>
