  ...
  return (
    <div className='bg-[#f2f2f2]'>
      <div className='relative h-[30rem] z-20'>
        ...
        <h1 className='absolute bottom-10 left-5 lg:left-10 text-white font-bold text-4xl lg:text-6xl'>Seguros para personas</h1>
        <p className='absolute bottom-5 left-5 lg:left-10 text-white lg:text-xl'><a href="/" className='text-[#f29494] hover:text-[#0830A6] duration-300'>HOME</a>/PERSONAS</p>
      </div>
